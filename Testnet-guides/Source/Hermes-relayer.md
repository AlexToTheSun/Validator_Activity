### Here is the instruction for Source <--> StaFiHub ibc relayer
## Documetnation
...
## Table of contents
1. [Relaying overwiew](https://github.com/AlexToTheSun/Validator_Activity/blob/main/Testnet-guides/Source/Hermes-relayer.md#relaying-overwiew)
2. [Configure opend RPC nodes and Fund keys](https://github.com/AlexToTheSun/Validator_Activity/blob/main/Testnet-guides/Source/Hermes-relayer.md#configure-opend-rpc-nodes-and-fund-keys)
- 1. [Source RPC node](https://github.com/AlexToTheSun/Validator_Activity/blob/main/Testnet-guides/Source/Hermes-relayer.md#sei-network-configure-opend-rpc-node)
- 2. [StaFiHub RPC node](https://github.com/AlexToTheSun/Validator_Activity/blob/main/Testnet-guides/Source/Hermes-relayer.md#stafihub-configure-opend-rpc-node)
3. [Install and configure Hermes](https://github.com/AlexToTheSun/Validator_Activity/blob/main/Testnet-guides/Source/Hermes-relayer.md#install-and-configure-hermes)
- 1. [Install Hermes](https://github.com/AlexToTheSun/Validator_Activity/blob/main/Testnet-guides/Source/Hermes-relayer.md#install-hermes-by-downloading)
- 2. [Hermes Configuration](https://github.com/AlexToTheSun/Validator_Activity/blob/main/Testnet-guides/Source/Hermes-relayer.md#hermes-configuration)
- 3. [Adding private keys](https://github.com/AlexToTheSun/Validator_Activity/blob/main/Testnet-guides/Source/Hermes-relayer.md#adding-private-keys)
4. [Configure new clients](https://github.com/AlexToTheSun/Validator_Activity/blob/main/Testnet-guides/Source/Hermes-relayer.md#configure-clients)
- 1. [Create-client](https://github.com/AlexToTheSun/Validator_Activity/blob/main/Testnet-guides/Source/Hermes-relayer.md#create-client)
- 2. [Query client state](https://github.com/AlexToTheSun/Validator_Activity/blob/main/Testnet-guides/Source/Hermes-relayer.md#query-client-state)
- 3. [Update-client](https://github.com/AlexToTheSun/Validator_Activity/blob/main/Testnet-guides/Source/Hermes-relayer.md#update-client)
5. [Connection Handshake](https://github.com/AlexToTheSun/Validator_Activity/blob/main/Testnet-guides/Source/Hermes-relayer.md#connection-handshake)
- 1. [Conn-init](https://github.com/AlexToTheSun/Validator_Activity/blob/main/Testnet-guides/Source/Hermes-relayer.md#conn-init)
- 2. [Conn-try](https://github.com/AlexToTheSun/Validator_Activity/blob/main/Testnet-guides/Source/Hermes-relayer.md#conn-try)
- 3. [Conn-ack](https://github.com/AlexToTheSun/Validator_Activity/blob/main/Testnet-guides/Source/Hermes-relayer.md#conn-ack)
- 4. [Conn-confirm](https://github.com/AlexToTheSun/Validator_Activity/blob/main/Testnet-guides/Source/Hermes-relayer.md#conn-confirm)
- 5. [Query connection](https://github.com/AlexToTheSun/Validator_Activity/blob/main/Testnet-guides/Source/Hermes-relayer.md#query-connection)
6. [Channel Handshake](https://github.com/AlexToTheSun/Validator_Activity/blob/main/Testnet-guides/Source/Hermes-relayer.md#channel-handshake)
- 1. [chan-open-init](https://github.com/AlexToTheSun/Validator_Activity/blob/main/Testnet-guides/Source/Hermes-relayer.md#chan-open-init)
- 2. [chan-open-try](https://github.com/AlexToTheSun/Validator_Activity/blob/main/Testnet-guides/Source/Hermes-relayer.md#chan-open-try)
- 3. [chan-open-ack](https://github.com/AlexToTheSun/Validator_Activity/blob/main/Testnet-guides/Source/Hermes-relayer.md#chan-open-ack)
- 4. [chan-open-confirm](https://github.com/AlexToTheSun/Validator_Activity/blob/main/Testnet-guides/Source/Hermes-relayer.md#chan-open-confirm)
- 5. [Query channel](https://github.com/AlexToTheSun/Validator_Activity/blob/main/Testnet-guides/Source/Hermes-relayer.md#query-channel)
7. [Transactions](https://github.com/AlexToTheSun/Validator_Activity/blob/main/Testnet-guides/Source/Hermes-relayer.md#transactions)
...
We will configure Hermes to operate between **Source** and **StaFiHub** in testnets.
## Source. Configure opend RPC node.
Now (03 September 2022) current testnet chain for Source Network is:
- `sourcechain-testnet`
1. **Run your own Source RPC node [[Instructions](https://github.com/AlexToTheSun/Validator_Activity/blob/main/Testnet-guides/Source/Basic-Installation-Synchronization.md)]**
...
```
sed -i.bak -e "s/^indexer *=.*/indexer = \""kv"\"/" $HOME/.source/config/config.toml
sed -i.bak -E "s|^(pex[[:space:]]+=[[:space:]]+).*$|\1true|" $HOME/.source/config/config.toml
sed -i '/\[grpc\]/{:a;n;/enabled/s/false/true/;Ta};/\[api\]/{:a;n;/enable/s/false/true/;Ta;}' $HOME/.source/config/app.toml
sed -i.bak -e "s%^laddr = \"tcp://127.0.0.1:26657\"%laddr = \"tcp://0.0.0.0:26657\"%" $HOME/.source/config/config.toml
sudo systemctl restart sourced
```
#### Check settings
Open in nano`$HOME/.source/config/config.toml` and make shure that `config.toml` contens lines:
```
#######################################################
...
...
```
Open in nano`$HOME/.source/config/app.toml` and make shure that `app.toml` contens the lines:
```
###############################################################################
###                           gRPC Configuration                            ###
###############################################################################
...
```
#### Fund your Source key.
Use Source testnet faucet from [Discord](https://discord.gg/cN5bquapAY) for funding your wallet that you will use for Hermes. It will be needed for paying relayer fees.
...
Use StaFiHub testnet faucet for funding your wallet that you will use for Hermes. It will be needed for paying relayer fees.
...
- `<source_grpc_port>`
```
chain_id_SOURCE="sourcechain-testnet"
rpc_addr_SOURCE="http://<source_node_ip>:<source_rpc_port>"
grpc_addr_SOURCE="http://<source_node_ip>:<source_grpc_port>"
websocket_addr_SOURCE="ws://<source_node_ip>:<source_rpc_port>/websocket"
account_prefix_SOURCE="source"
trusting_period_SOURCE="14days"
denom_SOURCE="usource"
max_tx_size_SOURCE="180000"
gas_price_SOURCE="0.001"
```
Example with standard ports:
```
chain_id_SOURCE="sourcechain-testnet"
rpc_addr_SOURCE="http://23.54.11.07:26657"
grpc_addr_SOURCE="http://23.54.11.07:9090"
websocket_addr_SOURCE="ws://23.54.11.07:26657/websocket"
account_prefix_SOURCE="source"
trusting_period_SOURCE="14days"
denom_SOURCE="usource"
max_tx_size_SOURCE="180000"
...
### CHAIN_Source ###
id = '${chain_id_Source}'
rpc_addr = '${rpc_addr_Source}'
grpc_addr = '${grpc_addr_Source}'
websocket_addr = '${websocket_addr_Source}'
rpc_timeout = '10s'
account_prefix = '${account_prefix_Source}'
key_name = 'wallet'
address_type = { derivation = 'cosmos' }
store_prefix = 'ibc'
default_gas = 100000
max_gas = 600000
gas_price = { price = '${gas_price_Source}', denom = '${denom_Source}' }
gas_multiplier = 1.1
max_msg_num = 30
max_tx_size = '${max_tx_size_Source}'
clock_drift = '5s'
max_block_time = '30s'
trusting_period = '${trusting_period_Source}'
...
In our example you should add **Source** and **StafiHub** keys. The `key_name` parameter from Hermes `config.toml`, is the name of the key that will be added after restoring Keys.

```
MNEMONIC_Source="speed rival market sure decade call silly flush derive story state menu inflict catalog habit swallow anxiety lumber siege fuel engage kite dad harsh"
...
sudo tee $HOME/.hermes/${chain_id_Source}.mnemonic > /dev/null <<EOF
${MNEMONIC_Source}
EOF
sudo tee $HOME/.hermes/${chain_id_Stafihub}.mnemonic > /dev/null <<EOF
${MNEMONIC_STAFIHUB}
EOF
hermes keys add --chain ${chain_id_Source} --mnemonic-file $HOME/.hermes/${chain_id_Source}.mnemonic
hermes keys add --chain ${chain_id_Stafihub} --mnemonic-file $HOME/.hermes/${chain_id_Stafihub}.mnemonic
```
# Configure clients
>  ❗️The identifiers given below are not valid and are given only for example❗️
Source:
...
#### Create a stafihub client on source
```
hermes tx raw create-client --host-chain sourcechain-testnet --reference-chain stafihub-public-testnet-3
```
...
#### Create a source client on stafihub
```
hermes tx raw create-client --host-chain stafihub-public-testnet-3 --reference-chain sourcechain-testnet
```
...
### Query client state
a stafihub client on source
```
hermes query client state --chain sourcechain-testnet --client 07-tendermint-626
```
a source client on stafihub
```
hermes query client state --chain stafihub-public-testnet-3 --client 07-tendermint-49
```
### update-client
#### Update the stafihub client on source
```
hermes tx raw update-client --host-chain sourcechain-testnet --client 07-tendermint-626
```
...
#### Update the source client on stafihub
```
...
### conn-init
```
hermes tx raw conn-init --dst-chain sourcechain-testnet --src-chain stafihub-public-testnet-3 --dst-client 07-tendermint-626 --src-client 07-tendermint-49
```
...
### conn-try
```
hermes tx raw conn-try --dst-chain stafihub-public-testnet-3 --src-chain sourcechain-testnet --dst-client 07-tendermint-49 --src-client 07-tendermint-626 --src-conn connection-299
```
...
### conn-ack
```
hermes tx raw conn-ack --dst-chain sourcechain-testnet --src-chain stafihub-public-testnet-3 --dst-client 07-tendermint-626 --src-client 07-tendermint-49 --dst-conn connection-299 --src-conn connection-35
```
...
### conn-confirm
```
hermes tx raw conn-confirm --dst-chain stafihub-public-testnet-3 --src-chain sourcechain-testnet --dst-client 07-tendermint-49 --src-client 07-tendermint-626 --dst-conn connection-35 --src-conn connection-299
```
...
first
```
hermes query connection end --chain sourcechain-testnet --connection connection-299
```
...
### chan-open-init
```
hermes tx raw chan-open-init --dst-chain sourcechain-testnet --src-chain stafihub-public-testnet-3 --dst-conn connection-299 --dst-port transfer --src-port transfer --order UNORDERED
```
...
### chan-open-try
```
hermes tx raw chan-open-try --dst-chain stafihub-public-testnet-3 --src-chain sourcechain-testnet --dst-conn connection-35 --dst-port transfer --src-port transfer --src-chan channel-276
```
...
### chan-open-ack
```
hermes tx raw chan-open-ack --dst-chain sourcechain-testnet --src-chain stafihub-public-testnet-3 --dst-conn connection-299 --dst-port transfer --src-port transfer --dst-chan channel-276 --src-chan channel-30
```
...
### chan-open-confirm
```
hermes tx raw chan-open-confirm --dst-chain stafihub-public-testnet-3 --src-chain sourcechain-testnet --dst-conn connection-35 --dst-port transfer --src-port transfer --dst-chan channel-30 --src-chan channel-276
```
...
### Query channel
```
hermes query channel end --chain sourcechain-testnet --port transfer --channel channel-276
```
...
Now we will send 999 ufis from StafiHub chain to StafiHub client generated on Source chain.
```
hermes tx raw ft-transfer \
--dst-chain  sourcechain-testnet \
...
Here we will send 10000 usource from Source chain to StafiHub chain (namely to Source client generated on StafiHub chain)
```
hermes tx raw ft-transfer \
--dst-chain  stafihub-public-testnet-3 \
--src-chain sourcechain-testnet \
--src-port transfer \
...
# As a result, you should get the following identificators for Source <--> StaFiHub
>  ❗️The values given below are not valid and are given only for example❗️
```
source:
